...
void FmgcComputer::step()
{
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    ...
    boolean_T rtb_appCapacity_idx_0;
    ...
    rtb_AND_g = (rtb_y_cjd == 0U);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.fac_own_bus.discrete_word_5, &rtb_y_f4);
    rtb_NOT5 = ((rtb_y_py != 0U) && (rtb_y_h3 != 0U) && rtb_AND_g && rtb_y_f4);
    rtb_y_f4 = ((!rtb_y_f4) || (!rtb_AND_g));
    ...
    FmgcComputer_MATLABFunction(!rtb_NOT5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge,
    ...
    fdOppOff = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                 rtb_NOT5) || rtb_OR_d);
    rtb_AND_g = ((!FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc) &&
    ...
    rtb_ap_inop_tmp = (rtb_ap_inop_tmp_tmp || (!rtb_ap_fd_condition) || (!rtb_AND_g));
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((static_cast<uint32_T>(rtb_y_fg &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && fdOppOff && rtb_ap_fd_condition && rtb_ap_fd_athr_condition && rtb_AND_g) <<
    ...
    rtb_AND_g = (rtb_y_fg && FmgcComputer_DWork.Memory_PreviousInput);
    ...
    FmgcComputer_DWork.Delay_DSTATE_p = FmgcComputer_P.Logic_table_h[(((static_cast<uint32_T>(rtb_AND_g) << 1) +
    ...
    rtb_AND_g = (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || FmgcComputer_U.in.discrete_inputs.fd_opp_engaged);
    rtb_fmgcOppPriority_tmp = !FmgcComputer_DWork.Delay_DSTATE_p;
    rtb_appCapacity_idx_2 = !fdOwnOff;
    rtb_fmgcOppPriority_tmp_0 = (rtb_AND_g || FmgcComputer_U.in.discrete_inputs.athr_opp_engaged);
    rtb_y_k4 = !FmgcComputer_DWork.Memory_PreviousInput_p;
    rtb_AND_g = (((!FmgcComputer_U.in.discrete_inputs.is_unit_1) || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_appCapacity_idx_2) && (rtb_AND_g || rtb_y_k4) &&
      rtb_fmgcOppPriority_tmp_0)) && (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_AND_g || rtb_appCapacity_idx_2) &&
      (rtb_fmgcOppPriority_tmp_0 || rtb_y_k4) && (FmgcComputer_DWork.Delay_DSTATE_p || fdOwnOff ||
    ...
    rtb_fmgcOppPriority_tmp = (rtb_AND_g && rtb_appCapacity_idx_2);
    ...
    FmgcComputer_MATLABFunction(rtb_NOT5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_h,
      FmgcComputer_P.ConfirmNode_timeDelay_i, &rtb_y_l2, &FmgcComputer_DWork.sf_MATLABFunction_hz);
    ...
    rtb_appCapacity_idx_0 = !rtb_fmgcOppPriority_tmp;
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((static_cast<uint32_T>
      ((FmgcComputer_U.in.fms_inputs.v2_available && (rtb_y_py != 0U) && rtb_fmgcOppPriority_tmp) ||
       (rtb_appCapacity_idx_0 && rtb_Memory &&
        (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active) && rtb_y_l2 &&
        FmgcComputer_U.in.fms_inputs.v2_available && (FmgcComputer_P.CompareToConstant_const_b <= 0) && rtb_OR_d)) << 1)
      + false) << 1) + FmgcComputer_DWork.Memory_PreviousInput_k];
    ...
    rtb_fmgcOppPriority_tmp_0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active;
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((static_cast<uint32_T>
      (rtb_fmgcOppPriority_tmp_0 && ((rtb_y_py != 0U) && rtb_fmgcOppPriority_tmp)) << 1) + false) << 1) +
    ...
    rtb_y_k4 = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed;
    ...
    FmgcComputer_MATLABFunction(rtb_NOT5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
    ...
    rtb_y_fg = !FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid;
    rtb_y_l2 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_y_fg && rtb_OR_d);
    ...
    rtb_Logic_o_idx_0_tmp = (rtb_Logic_o_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((static_cast<uint32_T>((((rtb_y_py != 0U)
      || (rtb_y_h3 != 0U)) && rtb_fmgcOppPriority_tmp) || (rtb_appCapacity_idx_0 && ((fdOppOff && rtb_Memory) ||
      rtb_y_l2))) << 1) + (rtb_Logic_o_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_f2];
    FmgcComputer_MATLABFunction_k(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit, &rtb_y_py);
    rtb_fmgcOppPriority_tmp_0 = ((rtb_y_py != 0U) && FmgcComputer_DWork.Memory_PreviousInput_f2);
    rtb_y_k4 = (FmgcComputer_DWork.Memory_PreviousInput_f2 && (rtb_y_py == 0U));
    FmgcComputer_MATLABFunction_k(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_fu, &rtb_y_py);
    FmgcComputer_MATLABFunction_k(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel2_bit_m, &rtb_y_h3);
    FmgcComputer_MATLABFunction_i(rtb_y_h3 != 0U, FmgcComputer_P.PulseNode_isRisingEdge_j, &rtb_y_l2,
      &FmgcComputer_DWork.sf_MATLABFunction_m1);
    rtb_Memory = ((!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active) &&
                  (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active) && rtb_y_l2);
    FmgcComputer_MATLABFunction_g(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_OR_d);
    FmgcComputer_MATLABFunction_g(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_l2);
    rtb_Memory = (rtb_Memory || (rtb_NOT5 && ((!rtb_OR_d) && (!rtb_y_l2)) &&
      (!FmgcComputer_P.fmgc_ap_fd_logic_output_MATLABStruct.any_lateral_mode_engaged)));
    rtb_y_l2 = (rtb_appCapacity_idx_0 && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid && rtb_Memory);
    rtb_OR_d = (((rtb_y_py != 0U) && rtb_fmgcOppPriority_tmp) || rtb_y_l2);
    FmgcComputer_MATLABFunction_g(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_Memory);
    FmgcComputer_MATLABFunction_g(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_l2);
    FmgcComputer_MATLABFunction_i(rtb_Memory || rtb_y_l2, FmgcComputer_P.PulseNode2_isRisingEdge, &rtb_y_l2,
      &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction_k(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_p, &rtb_y_py);
    FmgcComputer_MATLABFunction_i(rtb_y_py != 0U, FmgcComputer_P.PulseNode1_isRisingEdge, &rtb_Memory,
      &FmgcComputer_DWork.sf_MATLABFunction_jl);
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_l2 || rtb_Memory ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active) + (static_cast<uint32_T>(rtb_OR_d) << 1)) << 1) +
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((static_cast<uint32_T>(((rtb_y_py != 0U)
      && rtb_fmgcOppPriority_tmp) || (rtb_appCapacity_idx_0 && FmgcComputer_U.in.fms_inputs.nav_capture_condition &&
      (FmgcComputer_DWork.Memory_PreviousInput_i1 || FmgcComputer_U.in.fms_inputs.direct_to_nav_engage) &&
      ((rtb_DataTypeConversion >= FmgcComputer_P.CompareToConstant_const) || rtb_irOwnInvalid))) << 1) + (rtb_y_fg ||
      (rtb_Logic_o_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((static_cast<uint32_T>((rtb_y_py != 0U) &&
      rtb_fmgcOppPriority_tmp) << 1) + false) << 1) + FmgcComputer_DWork.Memory_PreviousInput_a];
    FmgcComputer_MATLABFunction_k(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel_bit_j, &rtb_y_py);
    rtb_y_l2 = (rtb_Logic_o_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((static_cast<uint32_T>((rtb_y_py != 0U)
      && rtb_fmgcOppPriority_tmp) << 1) + rtb_y_l2) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cv];
    FmgcComputer_MATLABFunction_g(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3, &rtb_y_l2);
    FmgcComputer_MATLABFunction_k(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    if (rtb_AND_g) {
      rtb_OR_d = ((rtb_y_py != 0U) && rtb_y_fg);
    } else {
      rtb_OR_d = false;
    }

    rtb_appCapacity_idx_0 = (rtb_appCapacity_idx_2 && rtb_OR_d);
    if (rtb_AND_g) {
      rtb_OR_d = ((rtb_y_h3 != 0U) && rtb_y_fg);
    } else {
      rtb_OR_d = false;
    }

    rtb_Memory = (rtb_appCapacity_idx_2 && rtb_OR_d);
    if (rtb_AND_g) {
      rtb_OR_d = ((rtb_y_cjd != 0U) && rtb_y_fg);
    } else {
      rtb_OR_d = false;
    }

    rtb_appCapacity_idx_2 = (rtb_appCapacity_idx_2 && rtb_OR_d);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_al);
    ...
    rtb_VectorConcatenate[12] = rtb_appCapacity_idx_0;
    rtb_VectorConcatenate[13] = rtb_Memory;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_hw);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_of);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_dv);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_mc);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_hdl);
    rtb_VectorConcatenate[0] = FmgcComputer_DWork.Memory_PreviousInput_c;
    ...
    rtb_VectorConcatenate[5] = rtb_fmgcOppPriority_tmp_0;
    rtb_VectorConcatenate[6] = rtb_y_k4;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_af);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_l5);
    FmgcComputer_Y.out.data = FmgcComputer_U.in;
    FmgcComputer_Y.out.logic.on_ground = rtb_NOT5;
    ...
    FmgcComputer_Y.out.logic.fmgc_opp_priority = rtb_AND_g;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.rwy_active = FmgcComputer_DWork.Memory_PreviousInput_c;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.hdg_active = rtb_fmgcOppPriority_tmp_0;
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.trk_active = rtb_y_k4;
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.rwy_loc_submode_active = false;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_2_capacity = rtb_appCapacity_idx_0;
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_passive_capacity = rtb_Memory;
    ...
    if (FmgcComputer_P.fmgc_ap_fd_logic_output_MATLABStruct.lateral_modes.align_submode_active ||
        FmgcComputer_P.fmgc_ap_fd_logic_output_MATLABStruct.lateral_modes.rollout_submode_active) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_5.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_5.Data = rtb_y_al;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_4.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_4.Data = rtb_y_hw;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.Data = rtb_y_of;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.Data = rtb_y_dv;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.Data = rtb_y_mc;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.Data = rtb_y_hdl;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.Data = rtb_y_af;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_6.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_6.Data = rtb_y_l5;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_4.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_4.Data = rtb_y_hw;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.Data = rtb_y_of;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.Data = rtb_y_mc;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.Data = rtb_y_hdl;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.Data = rtb_y_af;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active = FmgcComputer_DWork.Memory_PreviousInput_c;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active = rtb_fmgcOppPriority_tmp_0;
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active = rtb_y_k4;
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active = false;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_2_capacity = rtb_appCapacity_idx_0;
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_passive_capacity = rtb_Memory;
