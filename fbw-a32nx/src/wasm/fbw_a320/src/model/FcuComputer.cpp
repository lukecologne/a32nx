...
void FcuComputer::step()
{
  ...
  if (FcuComputer_U.in.sim_data.computer_running) {
    ...
    FcuComputer_Y.out.logic.capt_efis.efis_filter = rtb_efisFilter;
    FcuComputer_Y.out.logic.capt_efis.fd_on = rtb_Equal5;
    FcuComputer_Y.out.logic.capt_efis.ls_on = rtb_qnh;
    FcuComputer_Y.out.logic.capt_efis.baro_std = rtb_Equal7;
    FcuComputer_Y.out.logic.capt_efis.baro_qnh = rtb_Equal8;
    FcuComputer_Y.out.logic.capt_efis.baro_qfe = rtb_Equal9;
    FcuComputer_Y.out.logic.capt_efis.baro_value_hpa = static_cast<real32_T>(rtb_value_inhg);
    FcuComputer_Y.out.logic.capt_efis.baro_value_inhg = static_cast<real32_T>(rtb_value_hpa);
    ...
    FcuComputer_Y.out.logic.fo_efis.fd_on = rtb_Equal7;
    FcuComputer_Y.out.logic.fo_efis.ls_on = rtb_Equal6;
    FcuComputer_Y.out.logic.fo_efis.efis_filter = rtb_efisFilter;
    FcuComputer_Y.out.logic.fo_efis.baro_std = rtb_Equal9;
    FcuComputer_Y.out.logic.fo_efis.baro_qnh = rtb_qnh;
    FcuComputer_Y.out.logic.fo_efis.baro_qfe = rtb_qfe;
    FcuComputer_Y.out.logic.fo_efis.baro_value_hpa = static_cast<real32_T>(rtb_value_hpa);
    FcuComputer_Y.out.logic.fo_efis.baro_value_inhg = static_cast<real32_T>(rtb_value_inhg);
    rtb_Equal7 = !FcuComputer_U.in.discrete_inputs.ap_1_engaged;
    FcuComputer_Y.out.logic.fmgc_1_has_priority = (FcuComputer_U.in.discrete_inputs.ap_2_engaged || (rtb_Equal7 &&
      FcuComputer_U.in.discrete_inputs.fd_2_engaged) || (rtb_Equal7 && (!FcuComputer_U.in.discrete_inputs.fd_1_engaged) &&
      FcuComputer_U.in.discrete_inputs.athr_2_engaged));
    rtb_VectorConcatenate[0] = FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.baro_is_inhg;
    ...
    rtb_VectorConcatenate[14] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant2_Value_g);
    rtb_VectorConcatenate[15] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant1_Value_h);
    rtb_VectorConcatenate[16] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant3_Value_i);
    rtb_VectorConcatenate[17] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant4_Value_n);
    rtb_VectorConcatenate[18] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant5_Value_a);
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y_e);
    rtb_VectorConcatenate[0] = FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.baro_is_inhg;
    ...
    rtb_VectorConcatenate[14] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant2_Value_l);
    rtb_VectorConcatenate[15] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant1_Value_n);
    rtb_VectorConcatenate[16] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant3_Value_e);
    rtb_VectorConcatenate[17] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant4_Value_i);
    rtb_VectorConcatenate[18] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_range ==
      FcuComputer_P.EnumeratedConstant5_Value_k);
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y);
    rtb_VectorConcatenate[0] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant2_Value);
    rtb_VectorConcatenate[1] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant1_Value_b);
    rtb_VectorConcatenate[2] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant3_Value);
    rtb_VectorConcatenate[3] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant4_Value);
    rtb_VectorConcatenate[4] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant5_Value);
    rtb_VectorConcatenate[5] = FcuComputer_P.Constant10_Value_p;
    rtb_VectorConcatenate[6] = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant7_Value_k);
    rtb_VectorConcatenate[7] = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant6_Value_l);
    rtb_VectorConcatenate[8] = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant8_Value_a);
    rtb_VectorConcatenate[9] = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant9_Value_g);
    rtb_VectorConcatenate[10] = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant10_Value_b);
    rtb_VectorConcatenate[11] = FcuComputer_Y.out.logic.capt_efis.ls_on;
    rtb_VectorConcatenate[12] = !FcuComputer_Y.out.logic.capt_efis.fd_on;
    rtb_VectorConcatenate[13] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_navaid_1 ==
      FcuComputer_P.EnumeratedConstant12_Value);
    rtb_VectorConcatenate[14] = (FcuComputer_P.EnumeratedConstant12_Value ==
      FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_navaid_2);
    rtb_VectorConcatenate[15] = (FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_navaid_1 ==
      FcuComputer_P.EnumeratedConstant11_Value);
    rtb_VectorConcatenate[16] = (FcuComputer_P.EnumeratedConstant11_Value ==
      FcuComputer_Y.out.data.discrete_inputs.capt_efis_inputs.efis_navaid_2);
    rtb_VectorConcatenate[17] = FcuComputer_Y.out.logic.capt_efis.baro_std;
    rtb_VectorConcatenate[18] = FcuComputer_Y.out.logic.capt_efis.baro_qnh;
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y_k);
    rtb_VectorConcatenate[0] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant2_Value_a);
    rtb_VectorConcatenate[1] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant1_Value_m);
    rtb_VectorConcatenate[2] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant3_Value_l);
    rtb_VectorConcatenate[3] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant4_Value_b);
    rtb_VectorConcatenate[4] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_mode ==
      FcuComputer_P.EnumeratedConstant5_Value_e);
    rtb_VectorConcatenate[5] = FcuComputer_P.Constant10_Value_e;
    rtb_VectorConcatenate[6] = (FcuComputer_Y.out.logic.fo_efis.efis_filter == FcuComputer_P.EnumeratedConstant7_Value_a);
    rtb_VectorConcatenate[7] = (FcuComputer_Y.out.logic.fo_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant6_Value_l4);
    rtb_VectorConcatenate[8] = (FcuComputer_Y.out.logic.fo_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant8_Value_pn);
    rtb_VectorConcatenate[9] = (FcuComputer_Y.out.logic.fo_efis.efis_filter == FcuComputer_P.EnumeratedConstant9_Value_o);
    rtb_VectorConcatenate[10] = (FcuComputer_Y.out.logic.fo_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant10_Value_e);
    rtb_VectorConcatenate[11] = FcuComputer_Y.out.logic.fo_efis.ls_on;
    rtb_VectorConcatenate[12] = !FcuComputer_Y.out.logic.fo_efis.fd_on;
    rtb_VectorConcatenate[13] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_navaid_1 ==
      FcuComputer_P.EnumeratedConstant12_Value_a);
    rtb_VectorConcatenate[14] = (FcuComputer_P.EnumeratedConstant12_Value_a ==
      FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_navaid_2);
    rtb_VectorConcatenate[15] = (FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_navaid_1 ==
      FcuComputer_P.EnumeratedConstant11_Value_o);
    rtb_VectorConcatenate[16] = (FcuComputer_P.EnumeratedConstant11_Value_o ==
      FcuComputer_Y.out.data.discrete_inputs.fo_efis_inputs.efis_navaid_2);
    rtb_VectorConcatenate[17] = FcuComputer_Y.out.logic.fo_efis.baro_std;
    rtb_VectorConcatenate[18] = FcuComputer_Y.out.logic.fo_efis.baro_qnh;
    ...
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.fd_light_on = FcuComputer_Y.out.logic.capt_efis.fd_on;
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.ls_light_on = FcuComputer_Y.out.logic.capt_efis.ls_on;
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.cstr_light_on = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant7_Value);
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.wpt_light_on = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant6_Value);
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.vord_light_on = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant8_Value);
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.ndb_light_on = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant9_Value);
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.arpt_light_on = (FcuComputer_Y.out.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant10_Value);
    FcuComputer_Y.out.discrete_outputs.fo_efis_outputs.fd_light_on = FcuComputer_Y.out.logic.fo_efis.fd_on;
    FcuComputer_Y.out.discrete_outputs.fo_efis_outputs.ls_light_on = FcuComputer_Y.out.logic.fo_efis.ls_on;
    FcuComputer_Y.out.discrete_outputs.fo_efis_outputs.cstr_light_on = (FcuComputer_Y.out.logic.fo_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant7_Value_l);
    FcuComputer_Y.out.discrete_outputs.fo_efis_outputs.wpt_light_on = (FcuComputer_Y.out.logic.fo_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant6_Value_j);
    FcuComputer_Y.out.discrete_outputs.fo_efis_outputs.vord_light_on = (FcuComputer_Y.out.logic.fo_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant8_Value_p);
    FcuComputer_Y.out.discrete_outputs.fo_efis_outputs.ndb_light_on = (FcuComputer_Y.out.logic.fo_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant9_Value_f);
    FcuComputer_Y.out.discrete_outputs.fo_efis_outputs.arpt_light_on = (FcuComputer_Y.out.logic.fo_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant10_Value_i);
    ...
    FcuComputer_Y.out.bus_outputs.selected_vz_ft_min.Data = FcuComputer_P.Constant3_Value;
    ...
    FcuComputer_Y.out.bus_outputs.baro_setting_left_hpa.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.baro_setting_left_hpa.Data = FcuComputer_Y.out.logic.capt_efis.baro_value_hpa;
    FcuComputer_Y.out.bus_outputs.baro_setting_right_hpa.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.baro_setting_right_hpa.Data = FcuComputer_Y.out.logic.fo_efis.baro_value_hpa;
    FcuComputer_Y.out.bus_outputs.baro_setting_left_inhg.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.baro_setting_left_inhg.Data = FcuComputer_Y.out.logic.capt_efis.baro_value_inhg;
    FcuComputer_Y.out.bus_outputs.baro_setting_right_inhg.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.baro_setting_right_inhg.Data = FcuComputer_Y.out.logic.fo_efis.baro_value_inhg;
