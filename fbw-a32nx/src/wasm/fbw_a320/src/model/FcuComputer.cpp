...
void FcuComputer::FcuComputer_MATLABFunction_i(const base_arinc_429 *rtu_u, real_T rtu_bit, uint32_T *rty_y)
{
  real32_T tmp;
  uint32_T a;
...
void FcuComputer::step()
{
  ...
  if (FcuComputer_U.in.sim_data.computer_running) {
    ...
    if (!FcuComputer_DWork.Runtime_MODE) {
      ...
      FcuComputer_MATLABFunction_f_Reset(&FcuComputer_DWork.sf_MATLABFunction_m);
    ...
    FcuComputer_MATLABFunction_a(FcuComputer_U.in.discrete_inputs.capt_efis_inputs.arpt_button_pushed,
      FcuComputer_P.PulseNode4_isRisingEdge, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_bpf);
    FcuComputer_EFISFilterLogic(rtb_Equal7, rtb_Equal6, rtb_OR3_j, rtb_qnh, rtb_y_o, &rtb_efisFilter,
    ...
    FcuComputer_MATLABFunction_a(FcuComputer_U.in.discrete_inputs.capt_efis_inputs.fd_button_pushed,
      FcuComputer_P.PulseNode_isRisingEdge_n, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_ik);
    FcuComputer_MATLABFunction_m(rtb_y_o, &rtb_OR3_j, FcuComputer_P.TFlipFlop_init,
    ...
    FcuComputer_MATLABFunction_a(FcuComputer_U.in.discrete_inputs.capt_efis_inputs.ls_button_pushed,
      FcuComputer_P.PulseNode_isRisingEdge_nj, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_j);
    FcuComputer_MATLABFunction_m(rtb_y_o, &rtb_qnh, FcuComputer_P.TFlipFlop1_init,
    ...
    FcuComputer_MATLABFunction_a(FcuComputer_U.in.discrete_inputs.capt_efis_inputs.baro_knob.pulled,
      FcuComputer_P.PulseNode1_isRisingEdge_h, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_b3);
    FcuComputer_MATLABFunction_p(rtb_Equal6, rtb_y_o, &rtb_Equal7, &rtb_Equal8, &rtb_Equal9,
    ...
    FcuComputer_MATLABFunction_a(FcuComputer_U.in.discrete_inputs.fo_efis_inputs.arpt_button_pushed,
      FcuComputer_P.PulseNode4_isRisingEdge_a, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_cb);
    FcuComputer_EFISFilterLogic(rtb_Equal7, rtb_Equal6, rtb_OR3_j, rtb_qnh, rtb_y_o, &rtb_efisFilter,
    ...
    FcuComputer_MATLABFunction_p(rtb_Equal8, rtb_OR3_j, &rtb_Equal9, &rtb_qnh, &rtb_y_o,
    ...
    rtb_y_b = static_cast<real32_T>(rtb_DataTypeConversion3);
    rtb_y_cy = static_cast<real32_T>(rtb_DataTypeConversion2);
    rtb_OR3_j = rtb_Equal9;
    ...
    rtb_BusAssignment_ao_logic_fo_efis.baro_qfe = rtb_y_o;
    FcuComputer_MATLABFunction_a(FcuComputer_U.in.discrete_inputs.afs_inputs.trk_fpa_button_pressed,
      FcuComputer_P.PulseNode_isRisingEdge_oa, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_a4);
    if (rtb_y_o) {
    ...
    FcuComputer_MATLABFunction_a(FcuComputer_U.in.discrete_inputs.afs_inputs.metric_alt_button_pressed,
      FcuComputer_P.PulseNode1_isRisingEdge_ke, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_m);
    if (rtb_y_o) {
    ...
    FcuComputer_MATLABFunction_i(rtb_Switch_0, FcuComputer_P.BitfromLabel_bit, &rtb_Switch1);
    rtb_y_d0 = (rtb_Switch_0->SSM == static_cast<uint32_T>(SignStatusMatrix::NormalOperation));
    rtb_Equal9_e = ((rtb_Switch1 != 0U) && rtb_y_d0);
    FcuComputer_MATLABFunction_i(rtb_Switch_0, FcuComputer_P.BitfromLabel1_bit, &rtb_Switch1);
    ...
    FcuComputer_MATLABFunction((FcuComputer_U.in.discrete_inputs.afs_inputs.hdg_trk_knob.turns !=
      FcuComputer_P.CompareToConstant_const) && (!rtb_Equal9), FcuComputer_U.in.time.dt, &rtb_y_o,
      FcuComputer_P.MTrigNode_isRisingEdge, FcuComputer_P.MTrigNode_retriggerable,
      FcuComputer_P.MTrigNode_triggerDuration, &FcuComputer_DWork.sf_MATLABFunction_h);
    rtb_NOT1 = ((!rtb_y_o) && (!rtb_Equal9));
    if (!FcuComputer_DWork.pValue_not_empty_o) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        FcuComputer_DWork.pValue_e = FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.trk_deg;
        FcuComputer_DWork.pValue_not_empty_o = true;
      } else {
        FcuComputer_DWork.pValue_e = FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.hdg_deg;
        FcuComputer_DWork.pValue_not_empty_o = true;
      }
    }
    ...
    if (FcuComputer_DWork.prevTrkFpaActive_g != FcuComputer_DWork.p_trk_fpa_active) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        rtb_y_b = FcuComputer_DWork.pValue_e - FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.hdg_deg;
      } else {
        rtb_y_b = FcuComputer_DWork.pValue_e - FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.trk_deg;
      }

      if (rtb_y_b > 180.0F) {
        rtb_y_b -= 360.0F;
      } else if (rtb_y_b < -180.0F) {
        rtb_y_b += 180.0F;
      }

      if ((rtb_y_b < 5.0F) && FcuComputer_DWork.p_trk_fpa_active) {
        FcuComputer_DWork.pValue_e = FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.trk_deg;
      } else if ((rtb_y_b < 5.0F) && (!FcuComputer_DWork.p_trk_fpa_active)) {
        FcuComputer_DWork.pValue_e = FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.hdg_deg;
      }
    }
    ...
    if (!FcuComputer_DWork.pValue_not_empty_g) {
      FcuComputer_DWork.pValue_a = FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.alt_ft;
    ...
    FcuComputer_MATLABFunction((FcuComputer_U.in.discrete_inputs.afs_inputs.vs_fpa_knob.turns !=
      FcuComputer_P.CompareToConstant_const_j) && (!rtb_Equal9), FcuComputer_U.in.time.dt, &rtb_y_o,
      FcuComputer_P.MTrigNode_isRisingEdge_l, FcuComputer_P.MTrigNode_retriggerable_g,
      FcuComputer_P.MTrigNode_triggerDuration_c, &FcuComputer_DWork.sf_MATLABFunction_l);
    rtb_Equal8 = ((!rtb_y_o) && (!rtb_Equal9));
    ...
    if (!FcuComputer_DWork.pValue_not_empty) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        FcuComputer_DWork.pValue = FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.fpa_deg;
        FcuComputer_DWork.pValue_not_empty = true;
      } else {
        FcuComputer_DWork.pValue = FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data.vs_ft_min;
        FcuComputer_DWork.pValue_not_empty = true;
      }
    }
    ...
    rtb_BusAssignment_ao_logic_fo_efis.ls_on = rtb_Equal6;
    rtb_BusAssignment_ao_logic_fo_efis.efis_filter = rtb_efisFilter;
    rtb_BusAssignment_ao_logic_fo_efis.baro_std = rtb_OR3_j;
    rtb_BusAssignment_ao_logic_fo_efis.baro_qnh = rtb_qnh;
    ...
    FcuComputer_MATLABFunction_n(&rtb_BusAssignment_ao_logic_capt_efis,
      &FcuComputer_U.in.discrete_inputs.capt_efis_inputs, &rtb_baroMode, &rtb_y_b, &rtb_baroValueMode);
    rtb_capt_efis_outputs_baro_value_mode = rtb_baroMode;
    rtb_capt_efis_outputs_baro_value = rtb_y_b;
    ...
    FcuComputer_MATLABFunction_n(&rtb_BusAssignment_ao_logic_fo_efis, &FcuComputer_U.in.discrete_inputs.fo_efis_inputs,
      &rtb_baroValueMode, &rtb_y_b, &rtb_baroMode);
    rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_fo_efis_outputs_baro_value = rtb_y_b;
    ...
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y_bs);
    ...
    rtb_y_o = !rtb_BusAssignment_o_fd_on;
    rtb_VectorConcatenate[12] = rtb_y_o;
    ...
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y_cy);
    ...
    rtb_VectorConcatenate[16] = (FcuComputer_P.EnumeratedConstant11_Value_o ==
      FcuComputer_U.in.discrete_inputs.fo_efis_inputs.efis_navaid_2);
    rtb_VectorConcatenate[17] = rtb_OR3_j;
    ...
    rtb_VectorConcatenate[15] = rtb_y_o;
    ...
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y_lx);
    ...
    rtb_y_o = !FcuComputer_DWork.p_trk_fpa_active;
    rtb_VectorConcatenate[13] = rtb_y_o;
    ...
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y_c);
    FcuComputer_Y.out.data = FcuComputer_U.in;
    FcuComputer_Y.out.logic.afs.fmgc_1_has_priority = rtb_fmgc1Priority;
    FcuComputer_Y.out.logic.afs.chosen_fmgc_data = FcuComputer_P.Constant1_Value.afs.chosen_fmgc_data;
    ...
    FcuComputer_Y.out.logic.afs.selected_speed_control = (rtb_y_d0 && (rtb_Switch1 != 0U));
    ...
    FcuComputer_Y.out.bus_outputs.fcu_flex_to_temp_deg_c.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.fcu_flex_to_temp_deg_c.Data = FcuComputer_P.Constant8_Value;
    ...
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_left.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_left.Data = rtb_y_bs;
    ...
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_2_left.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_2_left.Data = rtb_y_cy;
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_2_right.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_2_right.Data = rtb_y_b;
    ...
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_2.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_2.Data = rtb_y_lx;
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_1.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_1.Data = rtb_y_c;
