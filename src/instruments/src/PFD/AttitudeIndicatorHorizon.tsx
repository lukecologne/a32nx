...
const TailstrikeIndicator = () => {
    ...
    const [throttle1] = useSimVar('GENERAL ENG THROTTLE LEVER POSITION:1', 'percent over 100');
    const [throttle2] = useSimVar('GENERAL ENG THROTTLE LEVER POSITION:2', 'percent over 100');

    if (radioAlt > 400 || airspeed < 50 || throttle1 >= 0.95 || throttle2 >= 0.95) {
        return null;
    }
    return (
