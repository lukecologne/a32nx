...
export class FCUSimvarPublisher extends SimVarPublisher<FcuSimvars> {
  private static simvars = new Map<keyof FcuSimvars, SimVarPublisherEntry<any>>([
    ...
    ['eisDisplayLeftNavaid1Mode', { name: FcuVars.eisDisplayLeftBaroMode, type: SimVarValueType.Number }],
    ['eisDisplayLeftNavaid2Mode', { name: FcuVars.eisDisplayLeftBaroMode, type: SimVarValueType.Number }],
    ...
    ['eisDisplayRightNavaid1Mode', { name: FcuVars.eisDisplayLeftBaroMode, type: SimVarValueType.Number }],
    ['eisDisplayRightNavaid2Mode', { name: FcuVars.eisDisplayLeftBaroMode, type: SimVarValueType.Number }],
