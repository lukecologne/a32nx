...
bool SimConnectInterface::prepareSimDataSimConnectDataDefinitions() {
  ...
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM TANK QUANTITY:12", "GALLONS");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM TANK QUANTITY:13", "GALLONS");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM TANK QUANTITY:14", "GALLONS");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM TANK QUANTITY:15", "GALLONS");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM TANK QUANTITY:16", "GALLONS");
  ...
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:154", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:155", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:156", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:157", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:158", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:159", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:160", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:161", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:162", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:163", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:164", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:165", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:166", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:167", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:168", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:169", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:170", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:171", "GALLONS PER HOUR");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM LINE FUEL FLOW:172", "GALLONS PER HOUR");
  ...
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM JUNCTION SETTING:14", "NUMBER");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM JUNCTION SETTING:15", "NUMBER");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM JUNCTION SETTING:16", "NUMBER");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM JUNCTION SETTING:17", "NUMBER");
  ...
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM PUMP ACTIVE:22", "NUMBER");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM PUMP ACTIVE:23", "NUMBER");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM PUMP ACTIVE:24", "NUMBER");
  result &= addDataDefinition(hSimConnect, 1, SIMCONNECT_DATATYPE_FLOAT64, "FUELSYSTEM PUMP ACTIVE:25", "NUMBER");
...
bool SimConnectInterface::prepareSimInputSimConnectDataDefinitions() {
  ...
  result &= addInputDataDefinition(hSimConnect, 0, Events::A32NX_FCU_TRUE_TOGGLE_PUSH, "A32NX.FCU_TRUE_TOGGLE_PUSH", false);
  ...
  result &= addInputDataDefinition(hSimConnect, 0, Events::A32NX_FCU_ALT_BUTTON_PUSH, "A32NX.FCU_ALT_BUTTON_PUSH", false);
...
bool SimConnectInterface::prepareClientDataDefinitions() {
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::AUTOPILOT_STATE_MACHINE, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(ClientDataAutopilotStateMachine));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::AUTOPILOT_LAWS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(ClientDataAutopilotLaws));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::PRIM_ANALOG_INPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_prim_analog_inputs));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::PRIM_DISCRETE_OUTPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_prim_discrete_outputs));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::PRIM_ANALOG_OUTPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_prim_analog_outputs));
  ...
  // map client id
  result &=
      SimConnect_MapClientDataNameToID(hSimConnect, "A32NX_CLIENT_DATA_PRIM_GENERAL_LOGIC_OUTPUT", ClientData::PRIM_GENERAL_LOGIC_OUTPUT);
  // create client data
  result &= SimConnect_CreateClientData(hSimConnect, ClientData::PRIM_GENERAL_LOGIC_OUTPUT, sizeof(base_prim_general_logic_outputs),
                                        SIMCONNECT_CREATE_CLIENT_DATA_FLAG_DEFAULT);
  // add data definitions
  ...
  for (int i = 0; i < 3; i++) {
    ...
    // add data definitions
    result &= SimConnect_AddToClientDataDefinition(hSimConnect, defineId, SIMCONNECT_CLIENTDATAOFFSET_AUTO, sizeof(base_prim_out_bus));
  ...
  for (int i = 0; i < 3; i++) {
    ...
    // add data definitions
    result &= SimConnect_AddToClientDataDefinition(hSimConnect, defineId, SIMCONNECT_CLIENTDATAOFFSET_AUTO, sizeof(base_ir_bus));
  }
  ...
  for (int i = 0; i < 3; i++) {
    ...
    // add data definitions
    result &= SimConnect_AddToClientDataDefinition(hSimConnect, defineId, SIMCONNECT_CLIENTDATAOFFSET_AUTO, sizeof(base_ra_bus));
  }
  ...
  for (int i = 0; i < 2; i++) {
    ...
    // add data definitions
    result &= SimConnect_AddToClientDataDefinition(hSimConnect, defineId, SIMCONNECT_CLIENTDATAOFFSET_AUTO, sizeof(base_lgciu_bus));
  }
  ...
  for (int i = 0; i < 2; i++) {
    ...
    // add data definitions
    result &= SimConnect_AddToClientDataDefinition(hSimConnect, defineId, SIMCONNECT_CLIENTDATAOFFSET_AUTO, sizeof(base_fmgc_b_bus));
  }
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::SEC_DISCRETE_INPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_sec_discrete_inputs));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::SEC_DISCRETE_OUTPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_sec_discrete_outputs));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::SEC_ANALOG_OUTPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_sec_analog_outputs));
  ...
  for (int i = 0; i < 3; i++) {
    ...
    // add data definitions
    result &= SimConnect_AddToClientDataDefinition(hSimConnect, defineId, SIMCONNECT_CLIENTDATAOFFSET_AUTO, sizeof(base_sec_out_bus));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::FAC_DISCRETE_INPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_fac_discrete_inputs));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::FAC_DISCRETE_OUTPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_fac_discrete_outputs));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::FAC_ANALOG_OUTPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_fac_analog_outputs));
  ...
  for (int i = 0; i < 2; i++) {
    ...
    // add data definitions
    result &= SimConnect_AddToClientDataDefinition(hSimConnect, defineId, SIMCONNECT_CLIENTDATAOFFSET_AUTO, sizeof(base_fac_bus));
  ...
  // map client id
  result &= SimConnect_MapClientDataNameToID(hSimConnect, "A32NX_CLIENT_DATA_FCU_DISCRETE_INPUT", ClientData::FCU_DISCRETE_INPUTS);
  // create client data
  result &= SimConnect_CreateClientData(hSimConnect, ClientData::FCU_DISCRETE_INPUTS, sizeof(base_fcu_discrete_inputs),
                                        SIMCONNECT_CREATE_CLIENT_DATA_FLAG_DEFAULT);
  // add data definitions
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::FCU_DISCRETE_INPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_fcu_discrete_inputs));

  // ------------------------------------------------------------------------------------------------------------------

  // map client id
  result &= SimConnect_MapClientDataNameToID(hSimConnect, "A32NX_CLIENT_DATA_FCU_DISCRETES_OUTPUT", ClientData::FCU_DISCRETE_OUTPUTS);
  // create client data
  result &= SimConnect_CreateClientData(hSimConnect, ClientData::FCU_DISCRETE_OUTPUTS, sizeof(base_fcu_discrete_outputs),
                                        SIMCONNECT_CREATE_CLIENT_DATA_FLAG_DEFAULT);
  // add data definitions
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::FCU_DISCRETE_OUTPUTS, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(base_fcu_discrete_outputs));

  // request data to be updated when set
  result &= SimConnect_RequestClientData(hSimConnect, ClientData::FCU_DISCRETE_OUTPUTS, ClientData::FCU_DISCRETE_OUTPUTS,
                                         ClientData::FCU_DISCRETE_OUTPUTS, SIMCONNECT_CLIENT_DATA_PERIOD_ON_SET);

  // ------------------------------------------------------------------------------------------------------------------

  for (int i = 0; i < 2; i++) {
    auto defineId = ClientData::FCU_1_BUS_OUTPUT + i;

    // map client id
    result &= SimConnect_MapClientDataNameToID(hSimConnect, ("A32NX_CLIENT_DATA_FCU_" + std::to_string(i + 1) + "_BUS").c_str(), defineId);
    // create client data
    result &= SimConnect_CreateClientData(hSimConnect, defineId, sizeof(base_fcu_bus), SIMCONNECT_CREATE_CLIENT_DATA_FLAG_DEFAULT);
    // add data definitions
    result &= SimConnect_AddToClientDataDefinition(hSimConnect, defineId, SIMCONNECT_CLIENTDATAOFFSET_AUTO, sizeof(base_fcu_bus));
  ...
  result &= SimConnect_AddToClientDataDefinition(hSimConnect, ClientData::LOCAL_VARIABLES, SIMCONNECT_CLIENTDATAOFFSET_AUTO,
                                                 sizeof(ClientDataLocalVariables));
...
void SimConnectInterface::resetFcuFrontPanelInputs() {
  fcuEfisPanelInputs[0] = {};
  fcuEfisPanelInputs[1] = {};
  fcuAfsPanelInputs = {};
}
...
bool SimConnectInterface::setClientDataPrimGeneralLogicOutput(const base_prim_general_logic_outputs& output) {
...
bool SimConnectInterface::setClientDataFcuDiscretes(base_fcu_discrete_inputs& output) {
  return sendClientData(ClientData::FCU_DISCRETE_INPUTS, sizeof(output), &output);
}

bool SimConnectInterface::setClientDataFcuBus(base_fcu_bus& output, int fcuIndex) {
...
void SimConnectInterface::processEvent(const DWORD eventId, const DWORD data0, const DWORD data1) {
  ...
  switch (eventId) {
    ...
    case Events::TOGGLE_FLIGHT_DIRECTOR: {
      fcuAfsPanelInputs.fd_button_pressed = true;
    ...
    case Events::A32NX_FCU_FD_PUSH: {
      fcuAfsPanelInputs.fd_button_pressed = 1;
      std::cout << "WASM: event triggered: A32NX_FCU_FD_PUSH" << std::endl;
      break;
    }
    ...
    case Events::A32NX_FCU_TRUE_TOGGLE_PUSH: {
      fcuAfsPanelInputs.true_mag_button_pressed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_TRUE_TOGGLE_PUSH" << std::endl;
      break;
    }
    ...
    case Events::A32NX_FCU_ALT_BUTTON_PUSH:
    case Events::AP_ATT_HOLD: {
      fcuAfsPanelInputs.alt_button_pressed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_ALT_BUTTON_PUSH" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_L_RANGE_INC: {
      fcuEfisPanelInputs[0].efis_range_knob_turns = 1;
      if (idSyncFoEfisEnabled->get()) {
        fcuEfisPanelInputs[1].efis_range_knob_turns = 1;
      }
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_RANGE_INC" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_L_RANGE_DEC: {
      fcuEfisPanelInputs[0].efis_range_knob_turns = -1;
      if (idSyncFoEfisEnabled->get()) {
        fcuEfisPanelInputs[1].efis_range_knob_turns = -1;
      }
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_RANGE_DEC" << std::endl;
      break;
    }
    ...
    case Events::A32NX_FCU_EFIS_L_MODE_INC: {
      ...
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_MODE_INC" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_L_MODE_DEC: {
      fcuEfisPanelInputs[0].efis_mode_knob_turns = -1;
      if (idSyncFoEfisEnabled->get()) {
        fcuEfisPanelInputs[1].efis_mode_knob_turns = -1;
      }
    ...
    case Events::A32NX_FCU_EFIS_L_VV_PUSH: {
      fcuEfisPanelInputs[0].vv_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_VV_PUSH" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_L_TAXI_PUSH: {
      fcuEfisPanelInputs[0].taxi_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_TAXI_PUSH" << std::endl;
      break;
    }
    ...
    case Events::A32NX_FCU_EFIS_L_NAVAID_1_PUSH: {
      fcuEfisPanelInputs[0].navaid_1_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_NAVAID_1_PUSH" << std::endl;
      break;
    }
    ...
    case Events::A32NX_FCU_EFIS_L_TRAF_PUSH: {
      fcuEfisPanelInputs[0].traf_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_TRAF_PUSH" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_L_WX_PUSH: {
      fcuEfisPanelInputs[0].wx_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_WX_PUSH" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_L_TERR_PUSH: {
      fcuEfisPanelInputs[0].terr_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_L_TERR_PUSH" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_R_RANGE_INC: {
      fcuEfisPanelInputs[1].efis_range_knob_turns = 1;
      if (idSyncFoEfisEnabled->get()) {
        fcuEfisPanelInputs[0].efis_range_knob_turns = 1;
      }
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_RANGE_INC" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_R_RANGE_DEC: {
      fcuEfisPanelInputs[1].efis_range_knob_turns = -1;
      if (idSyncFoEfisEnabled->get()) {
        fcuEfisPanelInputs[0].efis_range_knob_turns = -1;
      }
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_RANGE_DEC" << std::endl;
      break;
    }
    ...
    case Events::A32NX_FCU_EFIS_R_MODE_INC: {
      ...
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_MODE_INC" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_R_MODE_DEC: {
      fcuEfisPanelInputs[1].efis_mode_knob_turns = -1;
      if (idSyncFoEfisEnabled->get()) {
        fcuEfisPanelInputs[0].efis_mode_knob_turns = -1;
      }
    ...
    case Events::A32NX_FCU_EFIS_R_VV_PUSH: {
      fcuEfisPanelInputs[1].vv_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_VV_PUSH" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_R_TAXI_PUSH: {
      fcuEfisPanelInputs[1].taxi_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_TAXI_PUSH" << std::endl;
      break;
    }
    ...
    case Events::A32NX_FCU_EFIS_R_NAVAID_1_PUSH: {
      fcuEfisPanelInputs[1].navaid_1_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_NAVAID_1_PUSH" << std::endl;
      break;
    }
    ...
    case Events::A32NX_FCU_EFIS_R_TRAF_PUSH: {
      fcuEfisPanelInputs[1].traf_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_TRAF_PUSH" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_R_WX_PUSH: {
      fcuEfisPanelInputs[1].wx_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_WX_PUSH" << std::endl;
      break;
    }

    case Events::A32NX_FCU_EFIS_R_TERR_PUSH: {
      fcuEfisPanelInputs[1].terr_button_pushed = true;
      std::cout << "WASM: event triggered: A32NX_FCU_EFIS_R_TERR_PUSH" << std::endl;
      break;
    }
...
void SimConnectInterface::simConnectProcessClientData(const SIMCONNECT_RECV_CLIENT_DATA* data) {
  ...
  switch (data->dwRequestID) {
    ...
    case ClientData::FCU_DISCRETE_OUTPUTS:
      // store aircraft data
      clientDataFcuDiscreteOutputs = *((base_fcu_discrete_outputs*)&data->dwData);
      return;

    case ClientData::FCU_1_BUS_OUTPUT:
