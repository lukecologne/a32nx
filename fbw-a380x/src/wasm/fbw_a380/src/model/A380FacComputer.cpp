...
void A380FacComputer::step()
{
  ...
  if (A380FacComputer_U.in.sim_data.computer_running) {
    ...
    A380FacComputer_RateLimiter(look2_binlxpw(static_cast<real_T>(rtb_mach), static_cast<real_T>(rtb_Switch_i_idx_0),
      A380FacComputer_P.alphafloor_bp01Data, A380FacComputer_P.alphafloor_bp02Data,
      A380FacComputer_P.alphafloor_tableData, A380FacComputer_P.alphafloor_maxIndex, 4U),
      A380FacComputer_P.RateLimiterGenericVariableTs1_up, A380FacComputer_P.RateLimiterGenericVariableTs1_lo,
      A380FacComputer_U.in.time.dt, A380FacComputer_P.reset_Value, &rtb_Switch1, &A380FacComputer_DWork.sf_RateLimiter);
    ...
    if ((rtb_alpha_floor_inhib == 0) && (rtb_mach < 0.6)) {
      ...
      if ((rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg > A380FacComputer_P.Gain3_Gain * rtb_Switch1 + std::
           fmin(std::fmax(rtb_Switch6, static_cast<real_T>(rtb_v_ls_kn_SSM)), 0.0)) &&
    ...
    A380FacComputer_RateLimiter(look2_binlxpw(static_cast<real_T>(rtb_mach), static_cast<real_T>(rtb_Switch_i_idx_0),
      ...
      A380FacComputer_P.alphamax_maxIndex, 4U), A380FacComputer_P.RateLimiterGenericVariableTs4_up,
      A380FacComputer_P.RateLimiterGenericVariableTs4_lo, A380FacComputer_U.in.time.dt, A380FacComputer_P.reset_Value_o,
      &rtb_Switch1, &A380FacComputer_DWork.sf_RateLimiter_a);
    ...
    A380FacComputer_RateLimiter(look2_binlxpw(static_cast<real_T>(rtb_mach), static_cast<real_T>(rtb_Switch_i_idx_0),
      A380FacComputer_P.alphaprotection_bp01Data, A380FacComputer_P.alphaprotection_bp02Data,
      A380FacComputer_P.alphaprotection_tableData, A380FacComputer_P.alphaprotection_maxIndex, 4U),
    ...
    A380FacComputer_RateLimiter(look2_binlxpw(static_cast<real_T>(rtb_mach), static_cast<real_T>(rtb_Switch_i_idx_0),
      A380FacComputer_P.alphastallwarn_bp01Data, A380FacComputer_P.alphastallwarn_bp02Data,
      A380FacComputer_P.alphastallwarn_tableData, A380FacComputer_P.alphastallwarn_maxIndex, 4U),
